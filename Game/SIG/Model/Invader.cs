...
namespace SIG.Model
{
    internal class Invader : Sprite, IEnemy
    {
        ...
        /// Constructor
        /// </summary>
        public Invader(string p_graphics, Brush p_foreground, Size p_pixelSize, Point p_position, int[] p_spriteSequence, uint p_points)
